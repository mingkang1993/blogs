;(function ($) {
	$.createDialog = function(o) {
		...
		function getAjax(url,docObj) {
			docObj.empty();
			docObj.html('<div style="margin-top:40px;margin-left:'+((dfop.width-100)/2)+'px"><img src="'+RESOURCEPATH+'resource/images/loading.gif" alt="加载中..." /></div>');
			docObj.bgiframe();
			docObj.dialog(dfop);
...
*/		}
		...
		function getAjax(url,docObj) {
			docObj.empty();
			docObj.html('<div style="margin-top:40px;margin-left:'+((dfop.width-100)/2)+'px"><img src="resource/images/loading.gif" alt="加载中..." /></div>');
			docObj.dialog(dfop);
